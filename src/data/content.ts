...
export const PARTS: Part[] = [
  ...
  },
  {
    ...
    text: "Decine di piccole lamine snodate, la parte più difficile da forgiare: devono fermare un colpo di spada e al tempo stesso stringere le redini, l'elsa e la lancia.",
  },
  {
    id: "falda",
    name: "Falda",
  ...
  },
  {
    ...
    text: "Con alette laterali che sporgono verso l'esterno: è lì che passano i colpi delle mischie intorno al cavallo, all'altezza della staffa.",
  },
  {
    id: "schinieri",
    name: "Schinieri",
    ...
    text: "La gamba è il bersaglio preferito della fanteria contro il cavaliere: gli schinieri si chiudono a libro sul polpaccio con una cerniera, come due valve.",
  },
  {
    id: "sabatoni",
    name: "Sabatoni",
    ...
    y: 88.5,
    weight: "1,2 kg la coppia",
    text: "Piastre snodate sul piede. Nel gotico tedesco si allargano «a zampa d'orso» per non scivolare dalla staffa; in battaglia si rivelano una difesa quasi totale contro i colpi bassi.",
  },
];
