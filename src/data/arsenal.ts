...
export const WEAPONS: Weapon[] = [
  ...
  },
  {
    ...
    desc: "L'arma da duello del cavaliere appiedato: faccia a martello, becco «de corbin» e ascia, impiegate insieme a punta, leve e controllo dell'avversario. I trattati quattrocenteschi le dedicano capitoli interi: è al centro del combattimento in arnese.",
    stats: [
