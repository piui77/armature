...
export const WEAPONS: Weapon[] = [
  ...
  },
  {
    ...
    desc: "Si afferma insieme alla diffusione delle armature a piastra, cui è strettamente associato. La faccia a martello ammacca e stordisce; il becco posteriore concentra l'urto su elmi e giunti. In versione corta si usa da cavallo, in versione lunga nel duello appiedato.",
    stats: [
    ...
    antiArmor: 5,
    note: "Il becco concentra la forza dell'impatto su un'area molto ridotta e può essere efficace contro piastre e giunti, a seconda della costruzione dell'arma e della corazza.",
  },
  {
    id: "mazzafrusto",
    name: "Mazzafrusto",
