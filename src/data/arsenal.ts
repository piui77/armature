...
export const WEAPONS: Weapon[] = [
  {
    ...
    antiArmor: 2,
    note: "Contro l'armatura a piastre il taglio diventa meno efficace; acquistano maggiore importanza la punta, le aperture dell'armatura e le tecniche di combattimento ravvicinato.",
  },
  {
    id: "spada-lunga",
    name: "Spada lunga",
    ...
    antiArmor: 3,
    note: "Impugnata a mezza spada permette di controllare meglio la punta e di colpire o minacciare le aperture dell'armatura; pomolo e crociera potevano inoltre essere impiegati nel combattimento ravvicinato.",
  },
  {
    id: "spadone",
  ...
  },
  {
    ...
    stats: [
      ...
      { label: "La porta", value: "uomini d'arme e cavalieri" },
    ],
    antiArmor: 4,
    note: "È particolarmente adatta al combattimento ravvicinato e poteva essere impiegata contro le aperture e le zone meno protette dell'armatura.",
  },
  {
    id: "lancia-guerra",
    name: "Lancia da guerra",
    cat: "inastate",
    period: "Antichità–XVI sec.; la lancia in resta si afferma progressivamente nel Medioevo centrale",
    line: "Il motivo per cui esiste il cavaliere.",
    desc: "Con la lancia in resta, l'urto non è più del solo braccio: parte dell'impulso di cavallo e cavaliere si trasferisce al bersaglio concentrandosi sulla punta. Fu una delle armi fondamentali della cavalleria europea e, con lo sviluppo della lancia in resta, divenne particolarmente importante nella carica dei cavalieri pesantemente equipaggiati.",
    stats: [
    ...
    antiArmor: 4,
    note: "In resta permette di sfruttare in modo più efficace la massa e la velocità della carica, concentrando l'urto sulla punta; lo sviluppo della lancia in resta è una delle trasformazioni della guerra a cavallo nel Medioevo centrale.",
  },
  {
    id: "lancia-giostra",
  ...
  },
  {
    ...
    desc: "Taglia come un'ascia, fora come una lancia, uncina come un rampino. Le formazioni svizzere impiegarono alabarde e picche in combinazione; nel tardo Medioevo le fanterie svizzere dimostrarono in diverse battaglie di poter affrontare con successo anche la cavalleria pesante.",
    stats: [
      { label: "Asta", value: "1,8–2,5 m" },
      { label: "Testa", value: "2–3 kg" },
      { label: "La porta", value: "fanti svizzeri e lanzichenecchi" },
    ],
    antiArmor: 4,
  ...
  },
  {
    ...
    cat: "inastate",
    period: "XIV–XVI sec.",
    line: "Una delle armi più versatili del combattimento a piedi in armatura.",
    desc: "L'arma da duello del cavaliere appiedato: faccia a martello, becco «de corbin» e ascia, impiegate insieme a punta, leve e controllo dell'avversario. I trattati di combattimento del Quattrocento descrivono ampiamente il suo impiego nel combattimento a piedi in armatura.",
    stats: [
  ...
  },
  {
    ...
    cat: "inastate",
    period: "XIV–XVI sec.",
    line: "La foresta di punte che tiene a distanza la cavalleria.",
    desc: "Da sola è un bastone con una punta; in formazione è un muro di punte. Le lunghezze variavano secondo epoca e luogo; fra Quattro e Cinquecento i quadrati svizzeri e lanzichenecchi — da Nancy (1477) a Pavia (1525) — mostrarono che masse di fanti disciplinati potevano reggere l'urto della cavalleria.",
    stats: [
      { label: "Lunghezza", value: "3,5–6 m, secondo epoca" },
  ...
  },
  {
    ...
    cat: "inastate",
    period: "XIV–XVI sec.",
    line: "L'uncino che disarciona.",
    desc: "Il bill inglese e i suoi cugini continentali: lama, punta e uncino per agganciare il cavaliere, portarlo giù di sella. È un'arma militare a tutti gli effetti, diffusa fra fanti e arcieri inglesi e continentali.",
    stats: [
  ...
  },
  {
    ...
    desc: "La mazza a flange dell'uomo d'arme: non deve aprire la piastra, deve trasferire l'urto. Le flange concentrano il colpo in creste sottili che possono deformare la piastra e trasmettere una parte dell'energia al corpo.",
    stats: [
    ...
    antiArmor: 4,
    note: "La protezione a piastre non elimina il rischio di traumi provocati da colpi contundenti; per questo mazze e altre armi da impatto rimangono presenti nell'armamento tardo-medievale.",
  },
  {
    id: "martello",
    ...
    desc: "Si diffonde soprattutto nel tardo Medioevo, in un periodo in cui le armature a piastre diventano sempre più importanti. La faccia a martello ammacca e stordisce; il becco posteriore concentra l'urto su elmi e giunti. In versione corta si usa da cavallo, in versione lunga nel duello appiedato.",
    stats: [
    ...
    antiArmor: 5,
    note: "Il becco concentra la forza dell'impatto su un'area molto ridotta e può essere impiegato contro superfici corazzate e zone vulnerabili, con efficacia dipendente dalla costruzione dell'arma e della corazza.",
  },
  {
    id: "mazzafrusto",
    name: "Mazzafrusto",
    cat: "contundenti",
    period: "XIII–XV sec.",
    line: "La testa articolata può rendere più difficile una parata diretta.",
    desc: "Un manico, una catena, una testa snodata. Sotto questo nome convivono forme diverse, dai flagelli militari alle mazze articolate; forme articolate di questo tipo sono documentate in diversi contesti e periodi, ma la loro classificazione e il loro impiego variano considerevolmente.",
    stats: [
  ...
  },
  {
    ...
    cat: "distanza",
    period: "XIII–XV sec., soprattutto XIV–XV sec. in ambito inglese",
    line: "Una potente arma da tiro impiegata in grandi volée, capace di sottoporre uomini e cavalli a un intenso tiro a distanza.",
    desc: "L'arco lungo inglese, impiegato in grandi volée, ebbe un ruolo importante nelle battaglie di Crécy, Poitiers e Agincourt. La sua efficacia contro un'armatura a piastre variava in funzione della qualità della protezione, della distanza e delle condizioni dello scontro; i cavalli rimanevano particolarmente vulnerabili.",
    stats: [
